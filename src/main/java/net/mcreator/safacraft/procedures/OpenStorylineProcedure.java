...
public class OpenStorylineProcedure extends SafacraftModElements.ModElement {
	public OpenStorylineProcedure(SafacraftModElements instance) {
		super(instance, 26);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SafacraftMod.LOGGER.warn("Failed to load dependency entity for procedure OpenStoryline!");
			return;
		}
