package net.mcreator.safacraft;
...
public class SafacraftModVariables {
	public SafacraftModVariables(SafacraftModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("safacraft", "player_variables"), new PlayerVariablesProvider());
	}
