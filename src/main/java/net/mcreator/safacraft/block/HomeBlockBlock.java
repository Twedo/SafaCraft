...
import net.mcreator.safacraft.procedures.GoHomeProcedure;
...
public class HomeBlockBlock extends SafacraftModElements.ModElement {
	@ObjectHolder("safacraft:home_block")
	public static final Block block = null;
	public HomeBlockBlock(SafacraftModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				GoHomeProcedure.executeProcedure($_dependencies);
			}
