...
package net.mcreator.safacraft.world.dimension;
...
public class FlappyLairDimension extends SafacraftModElements.ModElement {
	public FlappyLairDimension(SafacraftModElements instance) {
		super(instance, 6);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("safacraft:flappy_lair"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
