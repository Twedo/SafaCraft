...
package net.mcreator.safacraft.world.biome;
...
public class FlappyPlainsBiome extends SafacraftModElements.ModElement {
	public static Biome biome;
	public FlappyPlainsBiome(SafacraftModElements instance) {
		super(instance, 6);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-16777114).setWaterFogColor(-16763905)
						.withSkyColor(7972607).withFoliageColor(-103).withGrassColor(-205).build();
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(FlappyEntity.entity, 20, 2, 6));
				...
				event.getRegistry().register(biome.setRegistryName("safacraft:flappy_plains"));
			}
		}
	}
	@Override
