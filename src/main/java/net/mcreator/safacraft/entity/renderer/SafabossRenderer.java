...
@OnlyIn(Dist.CLIENT)
public class SafabossRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SafabossEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsafa(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("safacraft:textures/unnamed.png");
					}
				};
			});
		}
	...
	public static class Modelsafa extends EntityModel<Entity> {
