...
public class FlappyEggItem extends SafacraftModElements.ModElement {
	@ObjectHolder("safacraft:flappy_egg")
	public static final Item block = null;
	public FlappyEggItem(SafacraftModElements instance) {
		super(instance, 31);
	}
